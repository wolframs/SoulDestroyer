package souldestroyer.shared.aspectratiomodifier
...
private fun Parent_200_200_Child_w3_h2_ref_height() {
    AspectRatioReferencePreviewParent(200.dp, 200.dp) { // Parent
        Surface( // Child
            ...
            border = BorderStroke(width = 1.dp, color = ratioViewPreviewChildStrokeColor),
            modifier = Modifier
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Box(
            ...
            Surface(
                ...
                border = BorderStroke(width = ratioViewPreviewStrokeWidth,  color = ratioViewPreviewParentColor),
                modifier = Modifier.fillMaxSize()
            ) {}
            Surface(
                color = Color.Transparent,
                border = BorderStroke(width = 1.dp,  color = ratioViewPreviewParentStrokeColor),
                modifier = Modifier
                    .fillMaxSize()
                    .padding(
